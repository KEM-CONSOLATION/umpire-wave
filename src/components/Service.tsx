  ...
  return (
    <div className="px-4 my-[70px]">
      ...
      >
        ...
        <p className="font-normal text-base text-gray-700 mt-2 max-w-lg mx-auto">
          Whether you&apos;re an emerging artist, an established brand, or a
          visionary filmmaker, Umpire Wave Studios delivers full-service
          solutions that help you create, connect, and captivate. Explore our
          diverse range of offerings below.
        </p>
      </div>
      ...
      <div className=" mt-[32px] grid md:grid-cols-2 place-items-center gap-[16px]">
        ...
        >
          ...
          <p className=" font-[400] text-[16px]">
            We manage the careers of talented musicians, helping them grow their
            brand, connect with the right audiences, and secure meaningful
            opportunities. Our services include:
          </p>
          <p>1. Talent discovery & grooming</p>
          <p>2. Brand partnerships, PR, tour booking</p>
        ...
        >
          ...
          <p className=" font-[400] text-[16px]">
            ...
            physical distribution to ensure your sound reaches fans everywhere:
          </p>
          <p>1. Spotify, Apple Music, Boomplay, Audiomack, etc.</p>
          <p>2. Royalty tracking and analytics</p>
        ...
        >
          ...
          <p>1. Music recording, mixing & mastering</p>
          <p>2. Voice-over recording</p>
          <p>3. Sound design & audio post-production</p>
        ...
        >
          ...
          <p>1. Recording studios</p>
          <p>2. Film and photography sets</p>
        ...
        >
          ...
          <p>1. Short films & feature films</p>
          <p>2. Music video direction & production</p>
          <p>3. Commercials & branded content</p>
          <p>4. Documentaries</p>
        </div>
        ...
        >
          ...
          <p>1. Concerts, festivals & launches</p>
          <p>2. Livestream & multi-cam setup</p>
        ...
        >
          ...
          <p>1. Album covers, promo shots</p>
          <p>2. Fashion/editorial photoshoots</p>
          <p>3. Event photography</p>
          <p>4. Studio rental for creatives</p>
        </div>
      </div>
    </div>
  );
